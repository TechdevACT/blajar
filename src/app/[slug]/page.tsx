  ...
  return (
    <div style={pageStyle} className="min-h-screen flex flex-col pb-24">
      ...
      <div className="sticky top-0 z-[60] flex flex-col">
        {/* TOP BANNER */}
        <div className="bg-accent text-accent-foreground text-center py-2.5 px-4 text-xs font-bold tracking-wide">
      ...
      <section id="buy" className="px-6 py-24 border-t border-border relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto bg-card border-2 border-accent rounded-3xl p-8 md:p-12 text-center shadow-2xl shadow-accent/10">
          ...
          <a href={p.mayar_url} target="_blank" rel="noopener noreferrer" className="block w-full bg-accent text-accent-foreground font-bold py-5 rounded-xl glow-accent hover:-translate-y-0.5 hover:glow-accent-lg transition-all text-lg mb-6">
      ...
      {/* BOTTOM STICKY BAR (Client Component) */}
      <StickyBottomBar name={p.name} price={p.price} mayarUrl={p.mayar_url} />
